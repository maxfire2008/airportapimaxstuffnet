import json
class Flight:
    def __init__(self,time=None,est_time=None,arrival_departure=None,aircraft=None,airline=None,location=None,terminal=None,gate=None,flight_number=None,cancelled=None,r=None):
        if time != None and est_time != None and arrival_departure != None and aircraft != None and airline != None and location != None and terminal != None and gate != None and flight_number != None and cancelled != None:
            self._time=time
...
"cancelled":self._cancelled})
    def __repr__(self):
        return "Flight("+repr(self._time)+","+repr(self._est_time)+","+repr(self._arrival_departure)+","+repr(self._aircraft)+","+repr(self._airline)+","+repr(self._location)+","+repr(self._terminal)+","+repr(self._gate)+","+repr(self._flight_number)+","+repr(self._cancelled)+")"

if __name__ == "__main__":
    testflight = Flight(1609380707,1609384307,"a","738","Qantas","Perth","A","5","QF2842",False)
